...
import com.gildedgames.the_aether.api.accessories.AetherAccessoryCompat;
...
public class GauntletCompatPatch
{
    ...
    {
        return AetherAccessoryCompat.getEquippedAccessoriesByClass(player, gauntletClass);
    }
