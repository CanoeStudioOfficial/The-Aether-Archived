package com.gildedgames.the_aether.lost.items;
...
import com.gildedgames.the_aether.lost.items.tools.ItemPhoenixTool;
...
public class ItemsLostAether
{
	...
	public static void initialization()
	{
		...
		platinum_key = register("platinum_key", new Item().setCreativeTab(AetherCreativeTabs.aether).setMaxStackSize(1));
	}
