...
import com.gildedgames.the_aether.lost.client.models.ModelAerwhaleKing;
...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation("aether_legacy", "textures/entities/king_aerwhale.png");
