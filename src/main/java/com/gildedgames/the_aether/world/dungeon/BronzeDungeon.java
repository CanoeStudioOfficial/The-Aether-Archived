...
public class BronzeDungeon extends AetherDungeonVirtual
{
	...
	{
		if(!isBoxSolid(world, new PositionData(pos.getX(), pos.getY() - 3, pos.getZ()), new PositionData(16, 18, 16)) || isSpaceTaken(world, new PositionData(pos.getX(), pos.getY() - 3, pos.getZ()), new PositionData(16, 16, 16)))
		{
			return false;
		}
