...
public class AetherConfig
{
	...
	public static final TinkersOptions tinkers_options = new TinkersOptions();

	public static class TinkersOptions
	{
		@Config.Comment("Whether Skyroot is enabled or not.")
		@Config.RequiresMcRestart
		public boolean skyroot = true;
